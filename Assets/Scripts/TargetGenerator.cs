...
public class TargetGenerator : MonoBehaviour
{
    ...
    */
    ...
    // 必要なのは今いる距離からどれだけ先までオブジェクトを生成したいか
    [Header("Set Z Position Offset Min and Max")]
    [Range(0f, 5f)]
    public float zMinPositionOffset = 0f;
    [Range(5f, 30f)]
    public float zMaxPositionOffset = 10f;
    ...
    private Vector3 GetRandomPosition()
    {
        ...
        zMinPosition = charaPos + zMinPositionOffset;
        zMaxPosition = charaPos + zMaxPositionOffset;
        //それぞれの座標をランダムに生成する
